        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.25rem", padding: "0 0.25rem" }}>
              ...
              <p style={{ ...styles.requirement, color: /[A-Z]/.test(newPassword) ? "rgba(245,245,245,0.5)" : "#666" }}>
                • One uppercase letter
              </p>
              <p style={{ ...styles.requirement, color: /\d/.test(newPassword) ? "rgba(245,245,245,0.5)" : "#666" }}>
                • One number
              </p>
            </div>
          </div>
